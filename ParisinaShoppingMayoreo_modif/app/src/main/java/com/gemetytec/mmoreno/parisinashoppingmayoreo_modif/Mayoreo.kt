...
/** Modulo de levantamiento de pedidos Mayoreo
 * **/

@Suppress("NULLABILITY_MISMATCH_BASED_ON_JAVA_ANNOTATIONS", "ALWAYS_NULL")
class Mayoreo : AppCompatActivity() {
        ...
        try{
           ...
           println("Dimenciones: $Dimencion     metricas: $metrics")
            ...
            if(Dimencion.contentEquals("2.75")){
                ...
                setContentView(R.layout.activity_mayoreo_480)
                ...
                if (metrics!!.heightPixels.toString() > "728" && metrics!!.heightPixels.toString() <= "800" ){
                    ...
                    setContentView(R.layout.activity_mayoreo_tab)
                    // requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
                    requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE
    ...
    */ //funcion para remplazar imagen para la traduccion
                ...
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.action == KeyEvent.ACTION_UP) {
                    ...
                    try{
                        if(String_Cantidad == ""){
                            ...
                            println("CampoCantidad: "+String_Cantidad.toString())
                        ...
                        Timber.e("error_cantidad: "+ EIO.toString())
    ...
    @RequiresApi(Build.VERSION_CODES.M)
    @SuppressLint("Range")
    fun ValidarCodigoArticulo(codigoProducto: String) {
        try {
            /**Comprobacion de conexion a red wifi**/
            VerificaConexion()
            if (flag_verif==0){
                ...
                cstmt.setString("@Modelo", "Mayoreo")
                cstmt.execute()
                ...
                while (results.next()){
                    ...
                    println(" - - - Lista de datos articulo:  ${Continuar_sp} - ${Message_error_sp} - ${Codigo_sp} - ${Name_articulo_sp} - ${precio_sp} - ${Descuento_sp}")
                }
    ...
    private fun TicketEnvio() {  //Fecha: String ,Hora: String,Folio:String,Nombre:String,Importe:String
        try {
            ...
            if( metrics!!.heightPixels.toString() == "1128" ){ //width=1200, height=1848
                ...
                println("+- activity_verificado_articulo 1128 mayoreo -+")

            }else{
                TextEntryView = factory.inflate(R.layout.activity_verificado_articulo, null)
                println("+- activity_verificado_articulo else mayoreo -+")
            }
            ...
            if( metrics!!.heightPixels.toString() == "1128" ){ //width=1200, height=1848
                ...
                println("+- verificado_articulo 1128 mayoreo -+")

            }else{
                Query.add(" "+Codigo_sp+"  |  "+Name_articulo_sp+"  |  "
                        +String_Cantidad+"  |  "+ total_importe+" ")

                println("+- verificado_articulo else mayoreo -+")
            }
    ...
    @SuppressLint("Range")
    fun ArticuloVeficadoCarrito(Codigo:String?, Name_articulo :String?, Cantidad:String?, Total_importe:Float?){
               ...
               println("Numero de caracteres codArtic: "+CodigoArticulo.count()+" NombreArticulo: "+NombreArticulo.count())
                ...
                if( metrics!!.heightPixels.toString() == "1128" ){ //width=1200, height=1848
                    Gridpedido!!.add("  "+CodigoArticulo+espacioCodigo+"|       "+espacioNombre+NombreArticulo+espacioNombre+"       |    "
                            +CantidadArticulo+"    |      "+ TotalCompra+"   ")
                    println("+- refreshArticulosGreadPrincipal 1128 mayoreo -+")
        ...
        try {
            ...
            builder!!.setPositiveButton("Si",
                DialogInterface.OnClickListener { dialogInterface, i ->
                    ...
                    try {
                        val Envio_Verif = Intent(this, BusquedaCliente::class.java)
                        Envio_Verif.putExtra("Folio",Folio_Cabecero)
                        Envio_Verif.putExtra("Cabecero_id",Id_Cabecero)
                        startActivity(Envio_Verif)

                    }catch (E1 : Exception){
                        Timber.e("error_BusquedaClient: "+ E1.toString())
                    }
                })
